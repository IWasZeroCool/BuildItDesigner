...
function DepartmentOfEducation(_x, _y) {
	this.type = "departmentOfEducation";
	...
	this.shape.name = "DepartmentOfEducation ("+this.x+","+this.y+")";
}

DepartmentOfEducation.prototype = new EducationBase();
