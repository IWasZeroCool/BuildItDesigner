...
function ReflectingPoolPark(_x, _y) {
	this.type = "reflectingPoolPark";
	...
	this.shape.name = "ReflectingPoolPark ("+this.x+","+this.y+")";
}

ReflectingPoolPark.prototype = new ParkBase();
