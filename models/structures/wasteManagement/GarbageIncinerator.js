...
function GarbageIncinerator(_x, _y) {
	this.type = "garbageIncinerator";
	...
	this.shape.name = "GarbageIncinerator ("+this.x+","+this.y+")";
}

GarbageIncinerator.prototype = new WasteManagementBase();
