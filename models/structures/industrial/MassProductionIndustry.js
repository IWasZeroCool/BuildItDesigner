...
function MassProductionIndustry(_x, _y) {
	this.type = "massProduction";
	...
	this.shape.name = "MassProductionIndustry ("+this.x+","+this.y+")";
}

MassProductionIndustry.prototype = new IndustrialBase();
